          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-center"  style="font-size: 24px; font-family: monospace, sans-serif;">modifier les informations   </h4>
                    <br>
                    <form action="{{ route('updatemy',  $personne->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
