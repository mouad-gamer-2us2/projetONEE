                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('storerecla') }}" method="POST">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control " name="etat"  value="pas encore traitée" aria-describedby="emailHelp">
                      
                        <input type="text" class="form-control " name="id_cli"  value="{{ $NUM_CONTRAT }}" aria-describedby="emailHelp">
                        ...
                        <input type="text" class="form-control " name="id_A_centre"  value="{{ $id }}" aria-describedby="emailHelp">
